# Calculus I Real Check

This course is a real-course workflow check for `Calculus I`.
...
- Update source here, then rebuild to refresh `courses/calculus1_real_check/output/`
