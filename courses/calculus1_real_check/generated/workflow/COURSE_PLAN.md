...
- deliverable: clean course source under `courses/calculus1_real_check` with clear data-type mapping and week-to-module logic
- status: in_progress
...
- deliverable: output under `courses/calculus1_real_check/output/`
- status: pending
