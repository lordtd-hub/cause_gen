...
- deliverable: clean course source under `courses/complex_variables_real_check` with clear data-type mapping and week-to-module logic
- status: in_progress
...
- deliverable: output under `courses/complex_variables_real_check/output/`
- status: pending
