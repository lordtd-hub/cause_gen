...
- course_dir: `courses/model_analysis_real_check`
- output_dir: `courses/model_analysis_real_check/output/`
...
- deliverable: clean course source under `courses/model_analysis_real_check` with clear data-type mapping and week-to-module logic
- status: in_progress
...
- deliverable: output under `courses/model_analysis_real_check/output/`
- status: pending
