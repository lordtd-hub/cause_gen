# Project In Mathematics Real Check

This course is a real-course workflow check for `Project in Mathematics`.
...
- `materials/processed/`
  TQF3 package, course-design extracts, problem pool artifacts, and source inventory.
- `generated/`
...
- Update source here, then rebuild to refresh `courses/project_in_mathematics_real_check/output/`
