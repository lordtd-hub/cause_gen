...
- course_dir: `courses/tmp-skill-test`
- output_dir: `courses/discrete_math_foundations/output/`
...
- deliverable: clean course source under `courses/tmp-skill-test` with clear data-type mapping and week-to-module logic
- status: in_progress
...
- deliverable: output under `courses/discrete_math_foundations/output/`
- status: pending
